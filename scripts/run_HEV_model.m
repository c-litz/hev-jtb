function run_HEV_model()
    ...
    % parameters (defaults)
    theta = 0.0005;
    alpha = 0.8; % relative trans. of asymp. to symp. infection in water
    ...
    gamma_s = 7.0/38.0;
    c_default = 1.0;
    beta_h = 0.0061356; % human-to-human transmissibility % when alpha=0.2, beta_h=0.045 and beta_w=0.099
    ...
    beta_w = 0.0290043; % water-to-human transmissibility
